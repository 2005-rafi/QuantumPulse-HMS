      ...
      await bedRepository.createAllocation(
        {
          ...
          comfortTier: bed.comfortTier || 'STANDARD',
          sharingType: bed.sharingType || 'GENERAL_WARD',
          dailyRateApplied: bed.dailyRateOverride || 0,
          hourlyRateApplied: bed.hourlyRateOverride || 0,
